...
include $(CLEAR_VARS)
LOCAL_C_INCLUDES := $(SPHINX_PATH)/include/android $(SPHINX_PATH)/include
LOCAL_CFLAGS += -DHAVE_CONFIG_H
LOCAL_CFLAGS += -DANDROID_NDK

LOCAL_PATH := $(SPHINX_PATH)/libsphinxbase/util
...
LOCAL_PATH := $(SPHINX_PATH)/libsphinxbase/fe
...
LOCAL_PATH := $(SPHINX_PATH)/libsphinxbase/feat
...
LOCAL_PATH := $(SPHINX_PATH)/libsphinxbase/lm
...
LOCAL_PATH := $(SPHINX_PATH)/libpocketsphinx
...
#sphinxutil sphinxfe sphinxfeat sphinxlm pocketsphinx
